                    ...
                    <form action="{{ route('quotes.update', $quote) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="md:col-span-2">
                                <label for="quote_number" class="block text-sm font-medium text-gray-700">請求番号<span class="text-red-500">*</span></label>
                                <input type="text" name="quote_number" id="quote_number" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm text-sm @error('name') border-red-500 @enderror" value="{{ old('quote_number', $quote->quote_number) }}" required>
                                @error('quote_number')
                            ...
                            <div class="md:col-span-6">
                                ...
                                <select name="project_id" id="project_id" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm text-sm @error('name') border-red-500 @enderror"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="md:col-span-8">
                                ...
                                <input type="text" id="subject" name="subject" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm text-sm @error('name') border-red-500 @enderror" value="{{ old('subject', $quote->subject) }}" required>
                                @error('subject')
                                    <p class="text-red-500 text-xs">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="expiry_date" id="expiry_date" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ old('expiry_date', $quote->expiry_date) }}">
                                @error('expiry_date')
                                    <p class="text-red-500 text-xs">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="issue_date" id="issue_date" class="flatpickr block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm text-sm @error('name') border-red-500 @enderror" value="{{ old('issue_date', $quote->issue_date) }}" required>
                                    <!-- カレンダーアイコン -->
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="md:col-span-12 grid grid-cols-1 md:grid-cols-12 gap-4">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative">
                                        <input type="text" name="delivery_date" id="delivery_date" class="flatpickr block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ old('delivery_date', $quote->delivery_date) }}">
                                        <!-- カレンダーアイコン -->
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400 mb-1" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="md:col-span-7">
                                    ...
                                    <input type="text" name="delivery_location" id="delivery_location" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ old('delivery_location', $quote->delivery_location) }}" maxlength="255">
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <input type="text" name="payment_terms" id="payment_terms" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ old('payment_terms', $quote->payment_terms) }}" maxlength="255">
                                    @error('payment_terms')
                                        <p class="text-red-500 text-xs">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="md:col-span-12">
                                ...
                                <textarea name="notes" id="notes" rows="3" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm">{{ old('notes', $quote->notes) }}</textarea>
                                @error('notes')
                                    <p class="text-red-500 text-xs">{{ $message }}</p>
                                @enderror
                            </div>
                                ...
                                @foreach(old('items', $quote->items) as $index => $item)
                                    ...
                                    <div class="item-row grid grid-cols-1 md:grid-cols-12 gap-4 items-end relative">
                                        ...
                                        <div class="md:col-span-5"> {{-- 品名 --}}
                                            ...
                                            <input type="text" name="items[{{ $index }}][item_name]" id="item_name_{{ $index }}" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm text-sm @error('name') border-red-500 @enderror" value="{{ $itemName }}" required>
                                        </div>
                                        <div class="md:col-span-2">
