<x-app-layout>
                    ...
                    <form action="{{ route('invoices.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="md:col-span-2">
                                <label for="invoice_number" class="block text-sm font-medium text-gray-700">請求番号<span class="text-red-500">*</span></label>
                                <input type="text" name="invoice_number" id="invoice_number" 
                                    class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm @error('invoice_number') border-red-500 @enderror" 
                            ...
                            @foreach($items as $index => $item)
                                <div class="item-row grid grid-cols-1 md:grid-cols-12 gap-4 items-end relative">
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <input type="text" name="items[{{ $index }}][item_name]" id="item_name_{{ $index }}" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ $item['item_name'] ?? '' }}" required>
                                    </div>
                                    <div class="md:col-span-2">
                        ...
                        <div class="mx-2 my-4">
                            ...
                            <div class="flex justify-end space-x-2">
                                ...
                                <a href="{{ route('invoices.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold pt-2 pb-1.5 pr-2 pl-2 text-sm rounded-md">キャンセル</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            let itemIndex = {{ old('items') ? count(old('items')) : (isset($invoice) && !$invoice->items->isEmpty() ? count($invoice->items) : 0) }};
