<x-app-layout>
                    ...
                    <form action="{{ route('deliveries.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="md:col-span-2">
                                <label for="delivery_number" class="block text-sm font-medium text-gray-700">納品書番号<span class="text-red-500">*</span></label>
                                <input type="text" name="delivery_number" id="delivery_number" 
                                    ...
                                    value="{{ old('delivery_number', $defaultDeliveryNumber ?? '') }}" 
                                    required>
                            ...
                            <div class="md:col-span-6">
                                ...
                                <select id="project_id" name="project_id" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm @error('project_id') border-red-500 @enderror" required
                            ...
                            <div class="md:col-span-4">
                                ...
                                <input type="text" id="client_name_display" class="block w-full py-1.5 border-gray-300 bg-gray-100 rounded-md text-sm cursor-not-allowed" readonly placeholder="イベントを選択してください">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="md:col-span-7">
                                ...
                                <input type="text" name="delivery_location" id="delivery_location" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ old('delivery_location') }}">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="payment_terms" id="payment_terms" class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ old('payment_terms', '銀行振込') }}">
                                @error('payment_terms')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="number" step="1"
                                            ...
                                            class="text-right block w-full py-1.5 border-gray-300 rounded-md
                                                focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm text-right no-spin item-price"
                                            value="{{ $item['price'] ?? '' }}">
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            flatpickr("#expiry_date", { dateFormat: "Y-m-d", allowInput: true, defaultDate: "{{ old('expiry_date', '') }}" });
