                    ...
                    <form method="POST" action="{{ route('projects.update', $project) }}">
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-2">
                            ...
                            <div class="col-span-1">
                                ...
                                <input type="text" value="{{ auth()->user()->name }}" class="block w-full py-1.5 border-gray-300 rounded-md text-sm bg-gray-100" disabled>
                        ...
                        <div class="mb-2">
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="block py-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm">{{ old('description', $project->description) }}</textarea>
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="p-3">
            ...
            <div class="block pt-3 text-xs text-blue-600 text-right">
                <a href="{{ route('admin.keyword_flags.index') }}"
