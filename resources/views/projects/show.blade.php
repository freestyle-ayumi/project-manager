                                    ...
                                    @if ($latestQuote)
                                        <div class="inline-flex items-center justify-end gap-2">
                                            ...
                                            title="{{ $hasQuotePdf ? 'PDFダウンロード' : '見積書PDF未出力（クリックで生成）' }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24"class="inline-block">
