                ...
                <div class="p-4">
                    ...
                    <form action="{{ route('clients.store') }}" method="POST">
                        ...
                        <div class="flex justify-end space-x-2">
                            <a href="{{ route('clients.index') }}" class="items-center px-4 py-2 text-xs bg-gray-300 border-transparent rounded-md hover:bg-gray-400 font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-1 transition ease-in-out duration-150 ms-4">
                                キャンセル</a>
