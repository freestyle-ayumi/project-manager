                                ...
                                @foreach ($quotes as $quote)
                                    <tr>
                                        ...
                                        <td class="px-2 py-3 whitespace-nowrap text-sm text-gray-900">
                                            ...
                                            @if ($quote->project)
                                                <a href="{{ route('projects.show', $quote->project) }}" class="text-blue-600 hover:text-blue-900 ml-1 inline-block align-middle" title="プロジェクト詳細へ">
                                        ...
                                        <td class="px-2 py-3 whitespace-nowrap text-right text-xs font-medium">
                                            ...
                                            <div class="flex items-center justify-end space-x-1">
                                                <a href="{{ route('quotes.show', $quote) }}" class="text-blue-500 hover:text-blue-900" title="詳細">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd" d="M10 12.5a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v2a.5.5 0 0 0 1 0v-2A1.5 1.5 0 0 0 9.5 2h-8A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-2a.5.5 0 0 0-1 0z"/>
                                                        <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/>
                                                    </svg>
                                                </a>
                                                <a href="{{ route('quotes.edit', $quote) }}" class="text-emerald-500 hover:text-emerald-900" title="編集"> 
                                                ...
                                                <form action="{{ route('quotes.destroy', $quote) }}" method="POST" class="inline-block" onsubmit="return confirm('本当にこの見積書を削除してもよろしいですか？');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-red-500 hover:text-red-900" title="削除">
