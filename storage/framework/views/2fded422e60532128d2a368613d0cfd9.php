<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('アカウントを削除すると、すべてのリソースとデータが完全に削除されます。アカウントを削除する前に、保持したいデータや情報をダウンロードしてください。')); ?>
...
<?php $component->withAttributes(['name' => 'confirm-user-deletion','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->userDeletion->isNotEmpty()),'focusable' => true]); ?>
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900">
                <?php echo e(__('アカウントを削除してもよろしいですか?')); ?>

            </h2>

            <p class="mt-1 text-sm text-gray-600">
                <?php echo e(__('アカウントを削除すると、すべてのリソースとデータが完全に削除されます。アカウントを完全に削除することを確認するため、パスワードを入力してください。')); ?>
...
<?php /**PATH C:\xampp\htdocs\project-manager\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>