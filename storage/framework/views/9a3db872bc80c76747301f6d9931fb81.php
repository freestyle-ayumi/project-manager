...
<head>
    ...
    <?php else: ?>
        <!-- 本番：ビルド済みアセット -->
        <?php $version = time(); ?>
        <link rel="stylesheet" href="<?php echo e(asset('build/assets/app-C8E9Y4sR.css')); ?>?v=<?php echo e($version); ?>">
        <script type="module" src="<?php echo e(asset('build/assets/app-BM3Wjlhc.js')); ?>?v=<?php echo e($version); ?>" defer></script>
    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\project-manager\resources\views/layouts/guest.blade.php ENDPATH**/ ?>