                    ...
                    <div class="space-y-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" 
                                   class="block py-1.5 w-full border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative rounded-md">
                                    <input type="number" step="any" name="latitude" id="latitude" value="<?php echo e(old('latitude')); ?>" 
                                           class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm"" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md">
                                    <input type="number" step="any" name="longitude" id="longitude" value="<?php echo e(old('longitude')); ?>" 
                                           class="block w-full py-1.5 border-gray-300 rounded-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="allowed_radius" id="allowed_radius" value="<?php echo e(old('allowed_radius', 100)); ?>" min="1" max="5000" 
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\project-manager\resources\views/admin/locations/create.blade.php ENDPATH**/ ?>