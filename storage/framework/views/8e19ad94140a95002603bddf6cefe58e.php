            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900" style="@media (max-width: 400px) {padding: 0.5rem;}">
                    ...
                    <div class="mb-4 text-right">
                        <a href="<?php echo e(route('roles.index')); ?>" class="inline-flex items-center pt-2 pb-1.5 px-2 bg-gray-800 text-white rounded text-xs font-semibold hover:bg-gray-700">
                            ロール管理
                        </a>
                    </div>
                            ...
                            <thead class="bg-gray-50 text-xs font-medium">
                                <tr>
                                    ...
                                    <th class="px-2 py-2 text-left uppercase tracking-wider">
                                        <a href="<?php echo e(route('users.index', ['sort_role' => request('sort_role') === 'asc' ? 'desc' : 'asc'])); ?>" class="hover:underline">
                                            ロール
                                            <?php if(request('sort_role')): ?>
                                                <?php echo e(request('sort_role') === 'asc' ? '↑' : '↓'); ?>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 text-gray-500 text-xs">
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="px-2 py-2"><?php echo e($user->email); ?></td>
                                        <td class="px-2 py-2"><?php echo e($user->role->description ?? 'N/A'); ?></td>
                                        <td class="px-2 py-2"><?php echo e($user->created_at?->format('y/m/d') ?? 'N/A'); ?></td>
                                        <td class="py-2 text-right">
                                            <div class="flex justify-center">
                                                <a href="<?php echo e(route('users.edit', $user)); ?>" class="text-emerald-600 hover:text-emerald-400" title="編集">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                                        <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001m-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708z"/>
                                                    </svg>
                                                </a>
                                                <form action="<?php echo e(route('users.destroy', $user)); ?>" method="POST" onsubmit="return confirm('このユーザーを削除します。よろしいですか？');">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project-manager\resources\views/users/index.blade.php ENDPATH**/ ?>