     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                勤務詳細：<?php echo e($user->name); ?>

            </h2>
            <a href="<?php echo e(route('admin.summary.index', ['month' => $selectedMonth])); ?>" class="text-sm text-indigo-600 hover:text-indigo-900 font-medium">
                &larr; 一覧に戻る
            </a>
        </div>
     <?php $__env->endSlot(); ?>
            ...
            <div class="bg-white p-4 shadow-sm sm:rounded-lg mb-4 text-gray-600">
                <div class="grid grid-cols-3 gap-2 border-b border-gray-100 mb-4 pb-2 px-2">
                    <div class="text-gray-900 text-lg font-bold">
                        <?php echo e(Carbon\Carbon::parse($selectedMonth)->format('Y年m月度')); ?>
                    ...
                    <div>
                        ...
                        <span class="ml-2 text-gray-900 text-sm font-semibold"><?php echo e($user->name); ?></span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-5 gap-2 mb-3 text-center">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-800"><?php echo e($monthlySummary['days_worked']); ?> <span class="text-xs font-normal">日</span></p>
                    </div>
                    <div>
                        <p class="text-gray-400 mb-1">欠勤日数</p>
                        <p class="text-lg font-bold text-red-500"><?php echo e($monthlySummary['absent_days']); ?> <span class="text-xs font-normal">日</span></p>
                    </div>
                    <div>
                        <p class="text-gray-400 mb-1">有休取得日数</p>
                        <p class="text-lg font-bold text-green-600"><?php echo e($monthlySummary['paid_holidays']); ?> <span class="text-xs font-normal">日</span></p>
                    </div>
                    <div>
                        <p class="text-gray-400 mb-1">代休取得日数</p>
                        <p class="text-lg font-bold text-orange-500"><?php echo e($monthlySummary['sub_holidays']); ?> <span class="text-xs font-normal">日</span></p>
                    </div>
                    <div>
                ...
                <div class="flex py-2 bg-gray-50 rounded-lg">
                    <div class="flex-1 text-center">
                        ...
                        <p class="text-xl font-bold text-indigo-600"><?php echo e($monthlySummary['total_work_time']); ?></p>
                    </div>

                    <div class="flex-1 text-center border-l border-gray-200">
                        <p class="text-gray-400 mb-1">早出残業時間</p>
                        <p class="text-xl font-bold text-gray-800"><?php echo e($monthlySummary['total_early_over']); ?></p>
                    </div>

                    <div class="flex-1 text-center border-l border-gray-200">
                        <p class="text-gray-400 mb-1">早朝深夜勤務時間</p>
                        <p class="text-xl font-bold text-gray-800"><?php echo e($monthlySummary['total_night']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-4 shadow-sm sm:rounded-lg overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white font-mono text-gray-700">
                        ...
                        <tr class="<?php echo e($data['day'] == '日' ? 'bg-red-50/50' : ($data['day'] == '土' ? 'bg-blue-50/50' : '')); ?> hover:bg-gray-50">
                            <td class="px-2 py-1.5 whitespace-nowrap"><?php echo e($data['date']); ?></td>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\project-manager\resources\views/admin/summary/show.blade.php ENDPATH**/ ?>