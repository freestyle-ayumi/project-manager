...
<?php endif; ?>
                            ...
                            <div class="col-span-1" 
                                x-data="{ 
                                    ...
                                    selectedColor: <?php echo e((int) old('color_id', $project->color_id)); ?>, 
                                    selectedHex: '<?php echo e($colors->firstWhere('id', (int) old('color_id', $project->color_id))->hex_code ?? '#3B82F6'); ?>' 
                                }">
                                <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-2"
                            x-data="userChips(
                                <?php echo e(json_encode($users)); ?>, 
                                <?php echo e(json_encode(array_map('intval', (array) old('users', $project->users->pluck('id')->toArray())))); ?>
