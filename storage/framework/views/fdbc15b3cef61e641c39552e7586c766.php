...
<?php $component->withAttributes([]); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                <div class="bg-white p-3 rounded-lg border border-gray-200">
                    <h3 class="font-bold text-xl mb-1 text-gray-800 flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" class="mb-0.5">
                        ...
                        <div class="flex flex-col space-y-4 px-10">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <button id="break-30-btn" onclick="submitAttendance('break_30')" 
                                    <?php echo e((!$todayClockedIn || $todayClockedOut || $isBusinessTrip || $needsFix) ? 'disabled' : ''); ?>

                                    class="<?php echo e((!$todayClockedIn || $todayClockedOut || $isBusinessTrip || $needsFix) ? 'opacity-50 cursor-not-allowed' : ''); ?> text-center py-3 text-slate-500 text-xs bg-slate-50 border border-slate-300 hover:bg-slate-400 hover:text-white transition rounded-sm disabled:opacity-50 disabled:cursor-not-allowed">
                                    休憩30分
                                </button>
                ...
                <div class="md:col-span-1 lg:col-span-2 bg-white p-3 rounded-lg border border-gray-200">
                    <h3 class="font-bold text-xl mb-1 text-gray-800 flex items-center gap-1">
                        ...
                        タイムカード
                        <span class="text-sm">（今週 + 前週）</span></h3>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const todayHasTakenBreak = <?php echo e($todayHasTakenBreak ? 'true' : 'false'); ?>;
        ...
        function updateButtons() {
            ...
            const needsFixStatus = <?php echo e($needsFix ? 'true' : 'false'); ?>;
