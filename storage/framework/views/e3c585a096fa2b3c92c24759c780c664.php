        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 text-xs text-gray-500">
            <div class="bg-white p-4 shadow-sm sm:rounded-lg">
                <form method="GET" class="mb-4 flex gap-2 items-center">
                    <div>
                        <input type="month" name="month" value="<?php echo e($month); ?>" class="py-1.5 pr-2 pl-3 block rounded-md border-gray-300 text-sm focus:border-indigo-500 focus:ring-indigo-500">
                    </div>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr>
                            <td class="px-2 py-2 whitespace-nowrap">
                                <span class="text-gray-900 font-medium"><?php echo e($data['name']); ?></span>
                            </td>
                            ...
                            <td class="px-2 py-2 whitespace-nowrap text-center">
                                <div class="flex justify-center gap-1">
                                    ...
                                    <a href="<?php echo e(route('admin.summary.show', [$data['id'], 'month' => $month])); ?>" 
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\project-manager\resources\views/admin/summary/index.blade.php ENDPATH**/ ?>