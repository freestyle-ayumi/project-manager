...
return [
    ...
    */
    ...
    'options' => [
        // ★ここから追加・変更
        'defaultFont' => 'ipaexgothic', // デフォルトフォントをIPAexゴシックに設定
        'isHtml5ParserEnabled' => true,
        'isRemoteEnabled' => true,
        'isPhpEnabled' => true,
        'isFontSubsettingEnabled' => false, // フォントサブセッティングは無効化（日本語の場合推奨）
        // ★ここまで追加・変更
        /**
         ...
         * Symbol, ZapfDingbats.
         */
        'font_dir' => storage_path('fonts/'), // ★フォントファイルを配置したディレクトリを指定
         ...
         * Note: This directory must exist and be writable by the webserver process.
         */
        'font_cache' => storage_path('app/dompdf_font_cache/'), // ★フォントキャッシュディレクトリを指定
    ...
    // ★ここから追加
    'font_manager' => [
        'enabled' => true, // フォントマネージャーを有効化
        'options' => [
            'fontDir' => storage_path('fonts/'), // ★フォントファイルを配置したディレクトリを指定
            'fontCache' => storage_path('app/dompdf_font_cache/'), // フォントキャッシュディレクトリ
            'defaultFont' => 'ipaexgothic', // こちらも設定
            'custom_font_families' => [
                'ipaexgothic' => [ // フォントファミリ名
                    'normal'      => storage_path('fonts/ipaexg.ttf'), // ★通常のフォントファイルパス
                    'bold'        => storage_path('fonts/ipaexg.ttf'), // 太字用（同じでもOK）
                    'italic'      => storage_path('fonts/ipaexg.ttf'), // 斜体用（同じでもOK）
                    'bold_italic' => storage_path('fonts/ipaexg.ttf'), // 太字斜体用（同じでもOK）
                ],
                'ipaexmincho' => [ // 必要であれば明朝体も追加 (ipaexm.ttfもstorage/fontsに配置した場合)
                    'normal'      => storage_path('fonts/ipaexm.ttf'),
                    'bold'        => storage_path('fonts/ipaexm.ttf'),
                    'italic'      => storage_path('fonts/ipaexm.ttf'),
                    'bold_italic' => storage_path('fonts/ipaexm.ttf'),
                ],
            ],
        ],
    ],
